// artifacts/email-platform/src/components/layout/DashboardLayout.tsx
  ...
  const navigation = [
    ...
    ...(user.role === "admin"
      ? [
          ...
          { name: "Usage",      href: "/dashboard/admin/usage",    icon: BarChart2      },
    ...
    <div className="min-h-screen flex bg-muted/30">
      ...
      >
        ...
        <div className="px-4 py-8 flex-1 overflow-y-auto space-y-1">
          <div className="text-xs font-semibold text-sidebar-foreground/40 uppercase tracking-wider mb-4 px-3">
            Menu
          </div>
          {navigation.map((item) => {
